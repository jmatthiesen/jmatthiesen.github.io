...
- **The latest news and articles** curated from authoriative sources talking about .NET AI development
...
![Chat window showing the question "How do I createn an MCP Server?" Followed by a response.](/assets/images/2025-10-21-announcing-csharp-ai-buddy-assistant.png)
...
![A Search field followed by a List of samples like "customer support" and "eShopLite"](/assets/images/2025-10-21-announcing-csharp-ai-buddy-samples.png)
